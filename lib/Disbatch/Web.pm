...
C<routes> (an object where fields are HTTP verbs and values are routes in the ordered configured), and C<dashboard> (an object with C<refresh_ms> and C<live_window_ms>,

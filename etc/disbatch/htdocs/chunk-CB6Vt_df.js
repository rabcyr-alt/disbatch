import {r as rs,E as Er,P as PB,g,Z as Zn,y as yw,B as Be,a3 as Ct,T,o as _e,bz as te$1,bA as ou,a$ as ig,a1 as ln,F as Fn,C as CI,bB as Yc,bf as jc,au as V1,aq as aC,G as Gi,R as Rh,f as Cu,a0 as Th,bH as Sd,c5 as Md,ar as cC,bC as pC,_ as _h,i as GD,$ as $h,x as Eu,as as tg,bD as ct,bE as q,bF as qo,p as H1,aQ as xh,A as bC,bo as Lh,bc as lC,bd as dC}from'./main.js';var Y=["*"],J=(()=>{class t{labelPosition="after";static \u0275fac=function(n){return new(n||t)};static \u0275cmp=CI({type:t,selectors:[["","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(n,c){n&2&&$h("mdc-form-field--align-end",c.labelPosition==="before");},inputs:{labelPosition:"labelPosition"},ngContentSelectors:Y,decls:1,vars:0,template:function(n,c){n&1&&(aC(),cC(0));},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return t})(),ge=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=rs({type:t});static \u0275inj=Er({imports:[ae,PB]})}return t})();export{J,ae as a,ge as g};
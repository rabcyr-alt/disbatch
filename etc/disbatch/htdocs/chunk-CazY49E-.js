import {l as go,V as Vn,o as j2,g,q as lr,s as ub,w as we,a3 as Ct,C,N as Ne,bz as te$1,bA as ou,a$ as Ug,a1 as ln,f as fn,a as gw,bB as Yc,bf as hu,au as Qj,aq as eC,u as us,h as hg,X as Xu,a0 as cg,bH as uf,c5 as lf,ar as tC,bC as sC,i as ag,e as LE,B as bg,Q as Qu,as as Lg,bD as ct,bE as q,bF as fi,K as Kj,aQ as fg,z as yC,bo as vg,bc as rC,bd as oC}from'./main-C25KCSAJ.js';var Y=["*"],J=(()=>{class t{labelPosition="after";static \u0275fac=function(n){return new(n||t)};static \u0275cmp=gw({type:t,selectors:[["","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(n,c){n&2&&bg("mdc-form-field--align-end",c.labelPosition==="before");},inputs:{labelPosition:"labelPosition"},ngContentSelectors:Y,decls:1,vars:0,template:function(n,c){n&1&&(eC(),tC(0));},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return t})(),ge=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=go({type:t});static \u0275inj=Vn({imports:[ae,j2]})}return t})();export{J,ae as a,ge as g};
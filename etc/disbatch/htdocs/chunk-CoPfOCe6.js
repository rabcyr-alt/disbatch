import {E,P as Pe}from'./chunk-COHcbp6j.js';import {g,br as G,d as de,f as fn,H as Hg,F as FV,bs as Xs,a as gw,bt as Mt,b as Hn,bu as sn,m as mi,c as di,bv as Q,bw as B,u as us,M as MC,X as Xu,_ as cg,h as hg,L as Lw,e as LE,r as rl,i as ag,j as jw,l as go,V as Vn,o as j2,q as lr,bj as Vs,s as ub,C,a1 as Ct,N as Ne$1,bx as te,by as ou,aZ as Ug,$ as ln,bz as Yc,bd as hu,as as Qj,ao as eC,ap as tC,bA as sC,B as bg,Q as Qu,aq as Lg,bB as ct,bC as q,bD as fi,K as Kj,aO as fg,z as yC,bm as vg,ba as rC,bb as oC,ax as Xw,au as xg,bE as Ag,bF as uf}from'./main-MWHZYWBV.js';import {J}from'./chunk-B57L580x.js';import'./chunk-CRoDEWfD.js';import {m}from'./chunk-BCBI0Y3w.js';import'./chunk-DE6OUiFl.js';var ye=["switch"],ke=["*"];function Ne(s,i){s&1&&(us(0,"span",11),uf(),us(1,"svg",13),cg(2,"path",14),Xu(),us(3,"svg",15),cg(4,"path",16),Xu()());}var xe=new C("mat-slide-toggle-default-options",{providedIn:"root",factory:()=>({disableToggleValue:false,hideIcon:false,disabledInteractive:false})}),S=class{source;checked;constructor(i,e){this.source=i,this.checked=e;}},I=(()=>{class s{_elementRef=g(lr);_focusMonitor=g(Vs);_changeDetectorRef=g(ub);defaults=g(xe);_onChange=e=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=false;_createChangeEvent(e){return new S(this,e)}_labelId;get buttonId(){return `${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus();}_noopAnimations=Ct();_focused=false;name=null;id;labelPosition="after";ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=false;color;disabled=false;disableRipple=false;tabIndex=0;get checked(){return this._checked}set checked(e){this._checked=e,this._changeDetectorRef.markForCheck();}hideIcon;disabledInteractive;change=new Ne$1;toggleChange=new Ne$1;get inputId(){return `${this.id||this._uniqueId}-input`}constructor(){g(te).load(ou);let e=g(new Ug("tabindex"),{optional:true}),d=this.defaults;this.tabIndex=e==null?0:parseInt(e)||0,this.color=d.color||"accent",this.id=this._uniqueId=g(ln).getId("mat-mdc-slide-toggle-"),this.hideIcon=d.hideIcon??false,this.disabledInteractive=d.disabledInteractive??false,this._labelId=this._uniqueId+"-label";}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,true).subscribe(e=>{e==="keyboard"||e==="program"?(this._focused=true,this._changeDetectorRef.markForCheck()):e||Promise.resolve().then(()=>{this._focused=false,this._onTouched(),this._changeDetectorRef.markForCheck();});});}ngOnChanges(e){e.required&&this._validatorOnChange();}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef);}writeValue(e){this.checked=!!e;}registerOnChange(e){this._onChange=e;}registerOnTouched(e){this._onTouched=e;}validate(e){return this.required&&e.value!==true?{required:true}:null}registerOnValidatorChange(e){this._validatorOnChange=e;}setDisabledState(e){this.disabled=e,this._changeDetectorRef.markForCheck();}toggle(){this.checked=!this.checked,this._onChange(this.checked);}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked));}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new S(this,this.checked))));}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static \u0275fac=function(d){return new(d||s)};static \u0275cmp=gw({type:s,selectors:[["mat-slide-toggle"]],viewQuery:function(d,t){if(d&1&&vg(ye,5),d&2){let u;rC(u=oC())&&(t._switchElement=u.first);}},hostAttrs:[1,"mat-mdc-slide-toggle"],hostVars:13,hostBindings:function(d,t){d&2&&(fg("id",t.id),Qu("tabindex",null)("aria-label",null)("name",null)("aria-labelledby",null),yC(t.color?"mat-"+t.color:""),bg("mat-mdc-slide-toggle-focused",t._focused)("mat-mdc-slide-toggle-checked",t.checked)("_mat-animation-noopable",t._noopAnimations));},inputs:{name:"name",id:"id",labelPosition:"labelPosition",ariaLabel:[0,"aria-label","ariaLabel"],ariaLabelledby:[0,"aria-labelledby","ariaLabelledby"],ariaDescribedby:[0,"aria-describedby","ariaDescribedby"],required:[2,"required","required",Qj],color:"color",disabled:[2,"disabled","disabled",Qj],disableRipple:[2,"disableRipple","disableRipple",Qj],tabIndex:[2,"tabIndex","tabIndex",e=>e==null?0:Kj(e)],checked:[2,"checked","checked",Qj],hideIcon:[2,"hideIcon","hideIcon",Qj],disabledInteractive:[2,"disabledInteractive","disabledInteractive",Qj]},outputs:{change:"change",toggleChange:"toggleChange"},exportAs:["matSlideToggle"],features:[Lg([{provide:ct,useExisting:fi(()=>s),multi:true},{provide:q,useExisting:s,multi:true}]),hu],ngContentSelectors:ke,decls:14,vars:27,consts:[["switch",""],["mat-internal-form-field","",3,"labelPosition"],["role","switch","type","button",1,"mdc-switch",3,"click","tabIndex","disabled"],[1,"mat-mdc-slide-toggle-touch-target"],[1,"mdc-switch__track"],[1,"mdc-switch__handle-track"],[1,"mdc-switch__handle"],[1,"mdc-switch__shadow"],[1,"mdc-elevation-overlay"],[1,"mdc-switch__ripple"],["mat-ripple","",1,"mat-mdc-slide-toggle-ripple","mat-focus-indicator",3,"matRippleTrigger","matRippleDisabled","matRippleCentered"],[1,"mdc-switch__icons"],[1,"mdc-label",3,"click","for"],["viewBox","0 0 24 24","aria-hidden","true",1,"mdc-switch__icon","mdc-switch__icon--on"],["d","M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z"],["viewBox","0 0 24 24","aria-hidden","true",1,"mdc-switch__icon","mdc-switch__icon--off"],["d","M20 13H4v-2h16v2z"]],template:function(d,t){if(d&1&&(eC(),us(0,"div",1)(1,"button",2,0),hg("click",function(){return t._handleClick()}),cg(3,"div",3)(4,"span",4),us(5,"span",5)(6,"span",6)(7,"span",7),cg(8,"span",8),Xu(),us(9,"span",9),cg(10,"span",10),Xu(),Lw(11,Ne,5,0,"span",11),Xu()()(),us(12,"label",12),hg("click",function(we){return we.stopPropagation()}),tC(13),Xu()()),d&2){let u=sC(2);ag("labelPosition",t.labelPosition),LE(),bg("mdc-switch--selected",t.checked)("mdc-switch--unselected",!t.checked)("mdc-switch--checked",t.checked)("mdc-switch--disabled",t.disabled)("mat-mdc-slide-toggle-disabled-interactive",t.disabledInteractive),ag("tabIndex",t.disabled&&!t.disabledInteractive?-1:t.tabIndex)("disabled",t.disabled&&!t.disabledInteractive),Qu("id",t.buttonId)("name",t.name)("aria-label",t.ariaLabel)("aria-labelledby",t._getAriaLabelledBy())("aria-describedby",t.ariaDescribedby)("aria-required",t.required||null)("aria-checked",t.checked)("aria-disabled",t.disabled&&t.disabledInteractive?"true":null),LE(9),ag("matRippleTrigger",u)("matRippleDisabled",t.disableRipple||t.disabled)("matRippleCentered",true),LE(),jw(t.hideIcon?-1:11),LE(),ag("for",t.buttonId),Qu("id",t._labelId);}},dependencies:[Yc,J],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return s})(),fe=(()=>{class s{static \u0275fac=function(d){return new(d||s)};static \u0275mod=go({type:s});static \u0275inj=Vn({imports:[I,j2]})}return s})();function Ie(s,i){s&1&&(us(0,"p",3),MC(1,"Loading\u2026"),Xu());}function Me(s,i){if(s&1&&(us(0,"div",4),MC(1),Xu()),s&2){let e=Xw();LE(),rl("No task with id ",e.id(),".");}}function Te(s,i){if(s&1&&(us(0,"div",5)(1,"dl",6)(2,"div")(3,"dt"),MC(4,"_id"),Xu(),us(5,"dd",7),MC(6),Xu()(),us(7,"div")(8,"dt"),MC(9,"queue"),Xu(),us(10,"dd",7),MC(11),Xu()(),us(12,"div")(13,"dt"),MC(14,"status"),Xu(),us(15,"dd"),MC(16),Xu()(),us(17,"div")(18,"dt"),MC(19,"node"),Xu(),us(20,"dd",7),MC(21),Xu()(),us(22,"div")(23,"dt"),MC(24,"ctime"),Xu(),us(25,"dd",7),MC(26),Xu()(),us(27,"div")(28,"dt"),MC(29,"mtime"),Xu(),us(30,"dd",7),MC(31),Xu()()(),us(32,"h3"),MC(33,"params"),Xu(),cg(34,"app-json-viewer",8),us(35,"h3"),MC(36,"stdout"),Xu(),us(37,"pre",9),MC(38),Xu(),us(39,"h3"),MC(40,"stderr"),Xu(),us(41,"pre",9),MC(42),Xu()()),s&2){let e=i,d=Xw();LE(6),xg(e._id),LE(5),xg(e.queue),LE(5),Ag("",e.status," (",d.statusLabel(),")"),LE(5),xg(e.node??"(none)"),LE(5),xg(e.ctime),LE(5),xg(e.mtime),LE(3),ag("value",e.params),LE(4),xg(d.outputText(e.stdout)),LE(4),xg(d.outputText(e.stderr));}}var ve=class s{route=g(G);tasksService=g(E);destroyRef=g(de);id=fn("");task=fn(null);notFound=fn(false);loading=fn(false);full=fn(false);statusLabel=Hg(()=>{let i=this.task();return i?Pe[i.status]??String(i.status):""});ngOnInit(){this.route.paramMap.pipe(FV(this.destroyRef),Xs(i=>(this.id.set(i.get("id")??""),this.tasksService.get(this.id(),this.full())))).subscribe({next:i=>this.handleResponse(i),error:i=>this.handleError(i)});}toggleFull(){this.full.update(i=>!i),this.loading.set(true),this.tasksService.get(this.id(),this.full()).pipe(FV(this.destroyRef)).subscribe({next:i=>this.handleResponse(i),error:i=>this.handleError(i)});}handleResponse(i){if(this.loading.set(false),"error"in i){this.task.set(null),this.notFound.set(true);return}this.task.set(i),this.notFound.set(false);}handleError(i){this.loading.set(false),this.task.set(null),this.notFound.set(i.status===404);}outputText(i){return i==null?"(none)":typeof i=="string"?i:'(stored in GridFS \u2014 toggle "full" to load)'}static \u0275fac=function(e){return new(e||s)};static \u0275cmp=gw({type:s,selectors:[["app-task-detail"]],decls:12,vars:5,consts:[["mat-icon-button","","routerLink","/tasks","matTooltip","Back to tasks"],[1,"spacer"],[3,"change","checked"],[1,"hint"],[1,"error-box"],[1,"detail-card"],[1,"fields"],[1,"mono"],[3,"value"],[1,"json"]],template:function(e,d){if(e&1&&(us(0,"mat-toolbar")(1,"a",0)(2,"mat-icon"),MC(3,"arrow_back"),Xu()(),us(4,"span"),MC(5),Xu(),cg(6,"span",1),us(7,"mat-slide-toggle",2),hg("change",function(){return d.toggleFull()}),MC(8,"full output"),Xu()(),Lw(9,Ie,2,0,"p",3),Lw(10,Me,2,1,"div",4),Lw(11,Te,43,10,"div",5)),e&2){let t;LE(5),rl("Task ",d.id()),LE(2),ag("checked",d.full()),LE(2),jw(d.loading()?9:-1),LE(),jw(d.notFound()?10:-1),LE(),jw((t=d.task())?11:-1,t);}},dependencies:[Mt,Hn,sn,mi,di,fe,I,Q,B,m],styles:["[_nghost-%COMP%]{display:block}mat-toolbar[_ngcontent-%COMP%]{margin-bottom:16px}.hint[_ngcontent-%COMP%]{color:#0000008a}.error-box[_ngcontent-%COMP%]{background:#ffebee;border:1px solid #ef9a9a;border-radius:6px;padding:16px;color:#c62828}.detail-card[_ngcontent-%COMP%]{background:#fff;border-radius:6px;padding:20px;box-shadow:0 1px 3px #0000001f}.fields[_ngcontent-%COMP%]{display:grid;grid-template-columns:1fr 1fr;gap:8px 24px;margin:0 0 16px}.fields[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]{display:flex;gap:8px}.fields[_ngcontent-%COMP%]   dt[_ngcontent-%COMP%]{font-weight:500;min-width:70px;color:#0009}.fields[_ngcontent-%COMP%]   dd[_ngcontent-%COMP%]{margin:0;word-break:break-all}h3[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:8px}.mono[_ngcontent-%COMP%]{font-family:Roboto Mono,Consolas,monospace;font-size:13px}"]})};export{ve as TaskDetailComponent};